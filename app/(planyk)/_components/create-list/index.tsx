  ...
  return (
    <Popover open={isOpen} onOpenChange={setIsOpen}>
      <PopoverTrigger asChild>
        <Plus className='bg-foreground rounded-full p-2 text-white dark:text-black' size={40} />
      </PopoverTrigger>
      <PopoverContent side={'bottom'} className='mb-16 w-[300px] p-3'>
        <div className='space-y-4'>
          <div className='relative w-full'>
            {listType === 'emoji' ? (
              ...
              <div
                className={cn(
                  'absolute top-0 left-0 m-2.5 h-5 w-5 rounded-full border-2 border-gray-500/50',
            ...
            <div className='w-full'>
              <Input
                ...
                className={cn(
                  ...
                  'w-full rounded-xl border-none pl-9'
                )}
                value={listName}
        ...
        <Button
          size='sm'
          className='mt-4 w-full rounded-xl border-none'
          disabled={isPending}
